...
<div
	...
	aria-label={hasExpandableContent
		? `${isExpanded ? 'Collapse' : 'Expand'} details for ${activity.title}`
		: undefined}
	id={componentId}
>
			...
			<div class="title-content">
				<h3 class="activity-title">
					...
					{#if hasExpandableContent}
						<button class="expand-indicator" aria-hidden="true" tabindex="-1">
							<svg viewBox="0 0 16 16" class="chevron {isExpanded ? 'rotated' : ''}">
								<path
									d="M6 4l4 4-4 4"
									stroke="currentColor"
									stroke-width="1.5"
