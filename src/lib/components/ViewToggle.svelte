	...
	>
		...
		<svg viewBox="0 0 16 16" class="icon" aria-hidden="true">
			<g stroke="currentColor" stroke-width="1.2" fill="none" stroke-linecap="round">
				...
				<path
					d="M2.5 3c0 0 1.5-1 4-0.5s3.5 1.5 6 0.5c0.5 0.3 1 1.2 1 2v7c0 0.5-0.3 1-1 1-2.5 1-3.5-1.5-6-0.5s-4 0.5-4 0.5c-0.5-0.2-1-0.8-1-1.5V4.5c0-0.7 0.5-1.3 1-1.5z"
				/>
				<!-- Map fold lines -->
				<path d="M6.5 2.5v11" />
				<path d="M10.5 2.5v11" />
