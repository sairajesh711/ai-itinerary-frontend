  ...
  >
      ...
      <div class="detail-section tips">
        <h4 class="detail-title">
          <svg viewBox="0 0 16 16" class="detail-icon">
            <path d="M8 2a6 6 0 100 12A6 6 0 008 2zM8 4a1 1 0 110 2 1 1 0 010-2zm0 3a1 1 0 011 1v3a1 1 0 01-2 0V8a1 1 0 011-1z" fill="currentColor"/>
          </svg>
          Tips
        </h4>
        <div class="tips-grid">
    ...
    {#if hasBooking}
      <div class="detail-section booking">
        <h4 class="detail-title">
          <svg viewBox="0 0 16 16" class="detail-icon">
            <path d="M3 4a1 1 0 011-1h8a1 1 0 011 1v8a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm2 0v8h6V4H5zm1 2h4v2H6V6z" fill="currentColor"/>
          </svg>
          Booking
        </h4>
          ...
          {#if activity.booking.required}
            <div class="booking-notice required">
              <svg viewBox="0 0 16 16" class="notice-icon">
                <path d="M8 2a6 6 0 100 12A6 6 0 008 2zM7 5a1 1 0 112 0v3a1 1 0 01-2 0V5zm1 7a1 1 0 100-2 1 1 0 000 2z" fill="currentColor"/>
              </svg>
              Booking Required
            </div>
          {:else}
            <div class="booking-notice recommended">
              Booking Recommended
            </div>
          {/if}
          ...
          {#if activity.booking.url}
            ...
            >
              <svg viewBox="0 0 16 16" class="link-icon">
                <path d="M7 3a1 1 0 000 2h2a1 1 0 100-2H7zM4 7a1 1 0 011-1h6a1 1 0 110 2H5a1 1 0 01-1-1zm0 4a1 1 0 011-1h6a1 1 0 110 2H5a1 1 0 01-1-1z" fill="currentColor"/>
              </svg>
              Book Now
              <svg viewBox="0 0 16 16" class="external-icon">
                <path d="M6 3a1 1 0 000 2h2.586L4.293 9.293a1 1 0 101.414 1.414L10 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1H6z" fill="currentColor"/>
              </svg>
            </a>
          {/if}
