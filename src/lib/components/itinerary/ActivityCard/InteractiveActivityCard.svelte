<script lang="ts">
	...
	function handleMouseEnter() {
		...
		InteractionService.triggerInteraction(componentId, mapPinId, 'hover', {
			dayIndex,
			activityIndex,
			activity
		});
	...
	function handleClick() {
		...
		// Trigger cross-view interaction with map pin
		InteractionService.triggerInteraction(componentId, mapPinId, 'click', {
			dayIndex,
			activityIndex,
			activity
		});
...
{#if mounted}
	...
	>
		...
		<div class="card-content">
			...
			<ActivityDetails {activity} {isExpanded} />
		</div>
