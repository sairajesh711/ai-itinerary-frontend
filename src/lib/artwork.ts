...
const ALIAS: Record<string, keyof typeof ART> = {
  // Western Europe
  paris: 'paris', france: 'paris', lyon: 'paris', nice: 'paris',
  london: 'london', uk: 'uk-london', 'united kingdom': 'uk-london', england: 'uk-london',
  madrid: 'spain', barcelona: 'spain', sevilla: 'spain', spain: 'spain',
  rome: 'italy', milan: 'italy', venice: 'italy', florence: 'italy', italy: 'italy',
  lisbon: 'spain', portugal: 'spain', porto: 'spain',

  // Eastern Europe
  prague: 'eastern-europe', czech: 'eastern-europe', 'czech republic': 'eastern-europe',
  budapest: 'eastern-europe', hungary: 'eastern-europe',
  warsaw: 'eastern-europe', krakow: 'eastern-europe', poland: 'eastern-europe',

  // Americas
  rio: 'brazil', brazil: 'brazil', 'rio de janeiro': 'brazil',
  nyc: 'nyc', 'new york': 'nyc', 'new york city': 'nyc',
  mexico: 'mexico', cancun: 'mexico', cdmx: 'mexico',
  peru: 'peru-chile-argentina', chile: 'peru-chile-argentina', argentina: 'peru-chile-argentina',
  lima: 'peru-chile-argentina', santiago: 'peru-chile-argentina', buenos: 'peru-chile-argentina',

  // Africa
  africa: 'africa', durban: 'africa', 'cape town': 'africa', nairobi: 'africa',

  // Middle East
  dubai: 'middle-east', uae: 'middle-east', israel: 'middle-east', jordan: 'middle-east', 'saudi arabia': 'middle-east',

  // Asia
  japan: 'japan', tokyo: 'japan', kyoto: 'japan', osaka: 'japan',
  china: 'china', beijing: 'china', shanghai: 'china',
  india: 'india', delhi: 'india', mumbai: 'india', agra: 'taj', taj: 'taj',
  'central asia': 'central-asia', kazakhstan: 'central-asia', uzbekistan: 'central-asia',
  'south east': 'southeast', 'southeast asia': 'southeast', thailand: 'southeast', vietnam: 'southeast',
  singapore: 'southeast', indonesia: 'southeast',
...
export function resolveArtwork(query: string | undefined | null): ArtMeta {
  ...
  if (key.includes('middle east') || key.includes('gulf') || key.includes('arab')) return ART['middle-east'];
  return ART.default;
}
